        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-5">
            <div class="grid lg:grid-cols-2 md:grid-cols-1 gap-4 mb-4">
                <div class="p-4 items-center justify-center rounded-sm bg-gray-50 dark:bg-gray-800">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" id="title" autocomplete="given-name" required value="{{$post->title}}"
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <textarea name="body" id="body" rows="3"
                            class="block w-full  min-h-[500px] h-auto rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 border-gray-400 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-400 sm:text-sm/6" required>{{$post->body}}
                        </textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="items-center justify-center mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
                <div class="col-span-full p-4">
                    ...
                    <div id="drop-zone" class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-400 px-6 py-10 cursor-pointer">
                        <input id="file-upload" name="file-upload" type="file" class="sr-only" accept="image/*">
                        <div class="text-center">
                            <svg id="upload-icon" class="mx-auto size-12 text-gray-300" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            ...
                            <div class="mt-4 text-sm text-gray-600">
                                <label for="file-upload"
                                    ...
                                    <span class="font-bold text-indigo-600 focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">Upload a file </span>
