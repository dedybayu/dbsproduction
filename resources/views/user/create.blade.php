    ...
    <form method="post" action="/create">
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-5">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <button type="button" data-modal-target="cancel-edit-modal" data-modal-toggle="cancel-edit-modal" class="text-sm/6 font-semibold text-gray-900 hover:text-gray-500">Cancel</button>
                <button type="submit"
