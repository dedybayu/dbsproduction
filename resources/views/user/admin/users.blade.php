<x-user.user-layout>
        ...
        <div class="relative p-4 w-full max-w-lg max-h-full">
            ...
            <div id="edit-user-content"
                ...
                <div
                    ...
                    <button data-modal-hide="edit-user-modal" class="hidden"></button>
                    <button type="button"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            let userRow = `
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                                <img class="w-10 h-10 rounded-full object-cover" src="${user.image ? '/storage/' + user.image : 'img/user.png'}" alt="User image">
                                                <div class="ps-3">
                                                    <div class="text-base font-semibold">
            ...
            document.querySelectorAll(".btn-close-edit", "btn-cancel-edit").forEach((button) => {
                button.addEventListener("click", function () {
                    closeEditModal();
                });
            });
