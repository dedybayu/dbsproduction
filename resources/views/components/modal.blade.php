...
@auth
    ...
    @can('is_admin')
        ...
        {{-- DELETE CATEGORY --}}
        <!-- Backdrop -->
        <div id="deleteUserBackdrop" class="hidden fixed inset-0 bg-black bg-opacity-50 z-40"></div>
        ...
        <div id="deleteUserModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative  text-center p-4 w-full max-w-md bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this User and all its
                    posts?</p>
