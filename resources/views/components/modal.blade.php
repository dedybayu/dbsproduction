...
@auth
    ...
    {{-- <button data-modal-target="cancel-edit-modal" data-modal-toggle="cancel-edit-modal"
        class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button">
        Toggle modal
    </button> --}}
    {{-- Cancel Edit Modal --}}
    <div id="cancel-edit-modal" tabindex="-1"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                <button type="button"
                    class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    data-modal-hide="cancel-edit-modal">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <a href="/myposts" data-modal-hide="cancel-edit-modal" type="button"
                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Yes, I'm sure
                    </a>
                    <button data-modal-hide="cancel-edit-modal" type="button"
                        class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">No,
                        cancel</button>
                </div>
            </div>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <form class="p-4 md:p-5" method="post">
                        ...
                        <div class="col-span-2">
                            <label for="category-color" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Category Color
                            </label>
...
{{-- 
        ...
        <!-- Backdrop -->
        <div id="deleteCategoryBackdrop" class="hidden fixed inset-0 bg-black bg-opacity-50 z-40"></div>

        <!-- Modal -->
        <div id="deleteCategoryModal" tabindex="-1" aria-hidden="true"
            class="hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-full">

            <div class="relative  text-center p-4 w-full max-w-md bg-white rounded-lg shadow dark:bg-gray-800">
                <button type="button"
                ...
                <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this Category and all its posts?</p>

                <form id="deleteCategoryForm" method="POST" action="">
                    @csrf
                    @method('DELETE')
                    <div class="flex justify-center space-x-4">
                        <button type="button" class="close-modal px-3 py-2 bg-gray-500 text-white rounded-lg">
                            No, cancel
                        </button>
