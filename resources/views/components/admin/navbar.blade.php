<nav class="fixed top-0 z-50 w-full bg-gray-800 border-b  dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="/" class="flex ms-2 md:me-24">
                    ...
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-gray-100">DBS Production</span>
                </a>
            </div>
